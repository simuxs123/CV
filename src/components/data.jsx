...
export const experienceData = [
  {
    ...
    year: (
      <h4>
        <span className="line-title">2019-2020</span>
      </h4>
    ),
  ...
  },
  {
    ...
    year: (
      <h4>
        <span className="line-title">2017-2019</span>
      </h4>
    ),
  ...
  },
  {
    ...
    year: (
      <h4>
        <span className="line-title">2016-2017</span>
      </h4>
    ),
    employer: <h5>Kauno Zalgiris</h5>,
    position: <h6>Professional football player</h6>,
  },
  {
    ...
    year: (
      <h4>
        <span className="line-title">2011-2016</span>
      </h4>
    ),
  ...
  },
  {
    ...
    year: (
      <h4>
        <span className="line-title">2007-2011</span>
      </h4>
    ),
...
export const projectsData = [
  {
    ...
    tags: (
      <p className="tag">
        ...
        <span>Html5, Css3, ReactJS, Bootstrap</span>
      </p>
    ),
    btns: (
      <div className="btns">
  ...
  },
  {
    ...
    tags: (
      <p className="tag">
        <FaTags className="tag-icon" />
        <span>Html5, Css3, ReactJS, Bootstrap, API</span>
      </p>
    ),
    btns: (
      <div className="btns">
  ...
  },
  {
    ...
    tags: (
      <p className="tag">
        <FaTags className="tag-icon" />
        <span>Html5, Css3, JS, Bootstrap, API</span>
      </p>
    ),
...
export const educationData = [
  {
    ...
    year: (
      <h4>
        <span className="line-title">2020-Current</span>
      </h4>
    ),
  ...
  },
  {
    ...
    year: (
      <h4>
        <span className="line-title">2007-2010</span>
      </h4>
    ),
  ...
  },
  {
    ...
    year: (
      <h4>
        <span className="line-title">2000-2007</span>
      </h4>
    ),
    ...
    personal: (
      <>
        <h2 className="info-title">
          <span className="line-title">Personal</span>
        </h2>
        <p>
